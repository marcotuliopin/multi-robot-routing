...
def plot_path(
    ...
    for next_reward in individual:
        ...
        if show_path:
            ax.plot([start[0], end[0]], [start[1], end[1]], linewidth=2, color=color, marker="o", markersize=6)
...
def plot_distances(path1: list, path2: list, distmx: np.ndarray, budget: int, save_plot: str = None):
